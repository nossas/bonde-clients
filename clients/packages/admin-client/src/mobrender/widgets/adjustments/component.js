    ...
    <FormGroup controlId="call-to-action-id" {...field}>
      ...
      <FormControl
        ...
        placeholder={intl.formatMessage({
          ...
          defaultMessage:
            'Ex: Preencha o formulário abaixo para assinar a petição.',
        })}
      />
    </FormGroup>
  ),
    ...
    <FormGroup controlId="button-text-id" {...field}>
      ...
      <FormControl
        ...
        placeholder={intl.formatMessage({
          ...
          defaultMessage:
            'Defina o texto do botão de confirmação do formulário.',
        })}
      />
    </FormGroup>
  ),
    ...
    <FormGroup controlId="count-text-id" {...field}>
      ...
      <FormControl
        ...
        placeholder={intl.formatMessage({
          ...
          defaultMessage:
            'Defina o texto que ficará ao lado do número de pessoas que agiram.',
        })}
      />
      <HelpBlock>
        <FormattedMessage
...
export const createAdjustmentsForm = (fieldList) => (props) => {
  ...
  return (
    ...
    >
      {fieldList
        .filter((name) => props.fields[name])
        .map((fieldName, indexFieldName) => {
