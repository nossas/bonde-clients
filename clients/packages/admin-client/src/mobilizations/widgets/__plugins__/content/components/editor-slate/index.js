...
export const createEditorContent = (content) =>
  JSON.stringify(Plain.deserialize(content).toJSON());
...
const ConnectedEditorSlate = injectIntl(
  connect(undefined, mapDispatchToProps)(EditorSlate)
);
