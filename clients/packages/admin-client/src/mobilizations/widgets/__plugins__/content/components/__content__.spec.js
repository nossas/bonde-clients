...
describe('client/mobilizations/widgets/__plugins__/content/components/__content__', () => {
  ...
  beforeEach(() => {
    contentWidget = shallowWithIntl(<Content {...props} intl={intl} />, {
      context: stubContext,
    });
  });
  ...
  it('should render wysihtml editor when settings content is HTML', () => {
    const widget = {
      settings: {
        content:
          '<div style="text-align: center;"><span>Clique aqui para editar o text...</span></div>',
      },
    };
    contentWidget.setProps({ widget });
