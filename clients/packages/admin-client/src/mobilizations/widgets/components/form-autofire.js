      ...
      <FormGroup controlId="senderName" {...senderName}>
        ...
        <FormControl
          ...
          placeholder={intl.formatMessage({
            ...
            defaultMessage:
              'Defina o nome que irá aparecer na mensagem enviada.',
          })}
        />
      </FormGroup>
      <FormGroup controlId="senderEmail" {...senderEmail}>
        ...
        <FormControl
          ...
          placeholder={intl.formatMessage({
            ...
            defaultMessage:
              'Defina o e-mail que irá aparecer na mensagem enviada.',
          })}
        />
      </FormGroup>
      <FormGroup controlId="emailSubject" {...emailSubject}>
        ...
        <FormControl
          ...
          placeholder={intl.formatMessage({
            ...
            defaultMessage:
              'Defina o assunto que irá aparecer na mensagem enviada.',
          })}
        />
      </FormGroup>
      <FormGroup controlId="emailText" {...emailText}>
        ...
        <FormControl
          ...
          placeholder={intl.formatMessage({
            ...
            defaultMessage:
              'Ex: Obrigado por apostar na força da ação coletiva em rede. Sua' +
