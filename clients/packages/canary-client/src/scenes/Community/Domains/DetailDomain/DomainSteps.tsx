...
import { HStack, Stack } from 'bonde-components/chakra';
import {
  ActiveDomainIcon,
  CertifyDomainIcon,
  ConnectDomainIcon,
...
export const InsertDomain: React.FC<Props> = () => {
  return (
    <HStack spacing={25}>
...
export const ConnectDomain: React.FC<Props> = ({ dnsHostedZone }) => {
  return (
    <HStack spacing={25}>
...
export const PropagateDomain: React.FC<Props> = ({ dnsHostedZone }) => {
  return (
    <HStack spacing={25}>
      <Stack align="center" maxW={165}>
        <PropagateDomainIcon />
        ...
        <Status
          isActived={() => dnsHostedZone?.status === 'propagated'}
