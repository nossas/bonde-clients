...
export const WIDGET_FORM_ENTRY_CREATE_REQUEST =
  'WIDGET_FORM_ENTRY_CREATE_REQUEST';
export const WIDGET_FORM_ENTRY_CREATE_SUCCESS =
  'WIDGET_FORM_ENTRY_CREATE_SUCCESS';
export const WIDGET_FORM_ENTRY_CREATE_FAILURE =
  'WIDGET_FORM_ENTRY_CREATE_FAILURE';
