...
import Container from '~routes/authenticated/sidebar/widgets-pressure-settings/container'

describe('routes/authenticated/sidebar/widgets-pressure-settings/container', () => {
  const props = {
