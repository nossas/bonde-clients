...
import Container from '~routes/authenticated/admin/widgets-pressure-settings/container'

describe('routes/authenticated/admin/widgets-pressure-settings/container', () => {
  const props = {
