...
import Container from '~routes/authenticated/sidebar/widgets-donation-settings/container'

describe('routes/authenticated/sidebar/widgets-donation-settings/container', () => {
  const props = {
