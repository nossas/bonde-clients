...
import MobilizationStyles from './pages/MobilizationStyles.jsx'
      ...
      <Route component={Application}>
        ...
        <Route component={Mobilizations} onEnter={requireAuth}>
          ...
          <Route component={Mobilization} >
            ...
            <Route path="/mobilizations/:mobilization_id/styles" components={{main: MobilizationStyles, sidebar: MobilizationMenu, topMenu: TopMenu}} />
