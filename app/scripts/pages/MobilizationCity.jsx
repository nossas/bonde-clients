...
class MobilizationCity extends React.Component {
...
(state, ownProps) => {
  ...
  return {
    auth: state.auth,
    saving: state.mobilization.saving,
    // TODO: Change store state by selectors
    mobilization: mobilization,
    initialValues: { organizationId: mobilization.organization_id }
  }
})(MobilizationCity)
