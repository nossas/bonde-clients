...
//     <Route path='/:mobilization_id' component={FetchTemplatesContainer}>                               <~ Migration In Progress
//       <Route path='/templates/choose' component={TemplateChoosePage} />                                <~ Migration In Progress
