...
class ChoiceCombined extends Component {
  ...
  render () {
    ...
    const placeholderImage = 'https://placeholdit.imgix.net/~text?txtsize=28&bg=e9e9e9&txtclr' +
      '=364C55&txt=300%C3%97300&w=300&h=300&txt=Carregue%20uma%20imagem'
    const image = bgImage || (match.goal_image ? match.goal_image : placeholderImage)
