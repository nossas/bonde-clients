...
import { Sidenav, SidenavList, SidenavListItem } from "../sidenav"



function Sidebar({ children, loading, mobilization, user, community }) {
              ...
              crossStorage
                ...
                .then(() => {
                  crossStorage
                    .del('auth', 'community')
                    .then(() => {
                      const loginUrl = import.meta.env.VITELOGIN_URL || 'http://bonde.devel:5000/login'
