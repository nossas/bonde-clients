...
import { ControlLabel, FormControl, FormDropdown, FormGroup, Raise } from "../../components/forms"
import { isBoolean } from "../../utils/type-checker"

import('./form-domain.scss')
      ...
      <div className='h5'>
        <p>
          <FormattedMessage
            ...
            defaultMessage="{strong}: você vai precisar configurar este domínio no seu servidor de registro para que o endereço seja redirecionado à página da sua mobilização. Pra isso, você vai precisar dessas informações aqui embaixo, anote aí:"
            values={{
              strong: (
                <strong>
                  <FormattedMessage
        ...
        <table className='col-12 left-align'>
          <tbody>
            ...
            <tr>
              ...
              <td><code>{mobilization.slug}.{import.meta.env.VITE_DOMAIN_ADMIN}</code></td>
            </tr>
            <tr>
                  ...
                  <div className='form-groups-container flex flex-wrap'>
                    ...
                    <FormGroup controlId='domain' {...domain}>
                      ...
                      >
                        ...
                        {hostedZones.map((object, index) => (
                          <option key={`hostedZone-${index}`} value={object.domain_name}>
                            {object.domain_name}
                          </option>
                        ))}
                      </FormDropdown>
