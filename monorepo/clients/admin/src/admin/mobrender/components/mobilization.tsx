...
class Mobilization extends React.Component {
  ...
  componentDidMount() {
    ...
    document.querySelector('#blocks-list').addEventListener('scroll', ({ target }) => {
      //
      ...
      const lastBlock = this.state.blocks.at(-1)
  ...
  updateBlock(block, newProperties) {
