...
function BlockChangeBackground({ mobilization, block, onChangeBackground, progress, onUploadFile, onCancelEdit, update }) {
  return <div className='absolute col-12 top-0 left-0 bg-darken-4 z5'>
