...
import ColorControls, {
	customStyleFn as colorCustomStyleFn
} from './ColorControls'
import FontControls, {
	customStyleFn as fontCustomStyleFn
} from './FontControls'
import HistoryControls from './HistoryControls'
import LinkControls, { decorator as linkDecorator } from './LinkControls'
import MediaControls, {
	blockRendererFn as mediaBlockRendererFn
} from './MediaControls'
			...
			>
				<div>
					...
					<button
						...
						className={classnames(
							buttonClassName,
							this.hasBlockType('ordered-list-item')
						)}
					...
					<button
						...
						className={classnames(
							buttonClassName,
							this.hasBlockType('unordered-list-item')
						)}
