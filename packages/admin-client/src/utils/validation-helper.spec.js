...
describe('client/utils/validation-helper', () => {
  ...
  describe('isValidTargetPhone', () => {
    it('should return true for "Isabelle Maitê <+551199999-9999>"', () => {
      expect(
        validator.isValidTargetPhone('Isabelle Maitê <+551199999-9999>')
      ).to.equal(true);
    });
    it('should return false for "Isabelle Maitê <+1199999-9999>"', () => {
      expect(validator.isValidPhone('Isabelle Maitê <+1199999-9999>')).to.equal(
        false
      );
    });
    ...
    it('should return false for "Foo Bar <foo@bar.com>"', () => {
      expect(validator.isValidTargetPhone('Foo Bar <foo@bar.com>')).to.equal(
        false
      );
    });
    it('should return false for " <>"', () => {
  ...
  describe('isValidDate', () => {
    it('should return false for `2017-21-01`', () => {
      expect(validator.isValidDate({ year: '2017', month: '21', day: '01' })).to
        .be.false;
    });
    it('should return false for `2017-01-40`', () => {
      expect(validator.isValidDate({ year: '2017', month: '01', day: '40' })).to
        .be.false;
    });
    it('should return true for `2017-01-01`', () => {
      expect(validator.isValidDate({ year: '2017', month: '01', day: '01' })).to
        .be.true;
    });
  });
});
