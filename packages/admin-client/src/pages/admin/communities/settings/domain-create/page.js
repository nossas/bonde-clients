...
class Page extends Component {
  ...
  handleTestConnection() {
    ...
    asyncCheckHostedZone(this.state.dns).then((dns) => {
      this.setState({ dns });
        ...
        >
          ...
          >
            <FormRedux
              ...
              {...formProps}
              onSubmit={(values) =>
                asyncAddHostedZone(values).then((dns) => {
                  if (dns.status !== 'error') {
                    this.setState({ dns });
                  }
                })
              ...
              <div className={styles.actionButtons}>
                <span style={{ marginRight: '1rem' }}>
                  <Button
                    ...
                    onClick={() =>
                      this.props.history.push(paths.communityDomain())
                    }
                  >
                    <FormattedMessage
          ...
          >
            ...
            {this.state.dns && this.state.dns.delegation_set_servers && (
              <Preformatted>
