...
import reducer, {
  initialState,
} from '../../../mobrender/redux/reducers/mobilizations';
...
describe('mobrender/redux/reducers/mobilizations', () => {
  describe('doing add', () => {
    it('#ADD_MOBILIZATION_REQUEST', () => {
      ...
      expect(nextState).to.deep.equal({ ...state, saving: true });
    });
  ...
  describe('doing fetch', () => {
    it('#FETCH_MOBILIZATIONS_REQUEST', () => {
      ...
      expect(nextState).to.deep.equal({ ...initialState, fetching: true });
    });
  ...
  describe('doing update', () => {
    ...
    it('#UPDATE_MOBILIZATION_REQUEST', () => {
      ...
      expect(nextState).to.deep.equal({ ...loadedState, saving: true });
    });
  ...
  describe('doing toggle menu', () => {
    ...
    it('#TOGGLE_MOBILIZATION_MENU off', () => {
      ...
      const nextState = reducer(state, action);
      expect(nextState).to.deep.equal({ ...state, menuActiveIndex: undefined });
    });
  });
  ...
  describe('finish fetch widgets and blocks', () => {
    ...
    it('#FETCH_BLOCKS_SUCCESS', () => {
      ...
      const nextState = reducer(state, action);
      expect(nextState).to.deep.equal({ ...state, reload: false });
    });
