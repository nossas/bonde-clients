    ...
    return (
      <div>
        <Head>
          ...
          <link rel='icon' type='image/png' sizes='32x32' href={favicon || require('../images/icon/favicon-32.png')} />
          <link rel='icon' type='image/png' sizes='16x16' href={favicon || require('../images/icon/favicon-16.png')} />
          <link
            type='text/css'
