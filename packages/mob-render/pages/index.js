...
const defaultFavicon32 = canUseDOM ? require('../images/icon/favicon-32.png') : ''
const defaultFavicon16 = canUseDOM ? require('../images/icon/favicon-16.png') : ''
    ...
    return (
      <div>
        <Head>
          ...
          <link rel='icon' type='image/png' sizes='32x32' href={favicon || defaultFavicon32} />
          <link rel='icon' type='image/png' sizes='16x16' href={favicon || defaultFavicon16} />
          <link
            type='text/css'
