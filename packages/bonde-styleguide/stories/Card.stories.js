...
<Row>
  <Cell size={[4, 4, 6, 6, 12, 12]}>
    <Card title='Lorem ipsum' minHeight='275px' maxHeight='275px'>
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quid loquor de nobis, qui ad
      laudem et ad decus nati, suscepti, instituti sumus? Quod praeceptum quia maius erat,
      quam ut ab homine videretur, idcirco assignatum est deo. Audi, ne longe abeam,
      moriens quid dicat Epicurus, ut intellegas facta eius cum dictis discrepare:
...
<Row>
  ...
  .add('image', () => (
    <div>
      <Title.H1>Card: image</Title.H1>
      <p>
        Image that will be displayed inside the Card component without paddings.
      </p>
      <p>
        The default characteristics of a Card with image property setted be demonstred below.
      </p>
      ...
      <Row>
        <Cell size={[3, 3, 6, 6, 12, 12]}>
          ...
          >
            <Title.H3 style={{ margin: '.5rem 0' }}>Cinzas dos Muros</Title.H3>
        ...
        <Cell size={[3, 3, 6, 6, 12, 12]}>
          ...
          >
            <Title.H3 style={{ margin: '.5rem 0' }}>Temer Jamais</Title.H3>
        ...
        <Cell size={[3, 3, 6, 6, 12, 12]}>
          ...
          >
            <Title.H3 style={{ margin: '.5rem 0' }}>Mulheres Inspiradoras</Title.H3>
        ...
        <Cell size={[3, 3, 6, 6, 12, 12]}>
          ...
          >
            <Title.H3 style={{ margin: '.5rem 0' }}>Vegan Já!</Title.H3>
